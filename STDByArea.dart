...
//
//     final stdByArea = stdByAreaFromJson(jsonString);

import 'dart:convert';

StdByArea stdByAreaFromJson(String str) => StdByArea.fromJson(json.decode(str));

String stdByAreaToJson(StdByArea data) => json.encode(data.toJson());
...
class StdByArea {
    ...
    factory StdByArea.fromJson(Map<String, dynamic> json) => StdByArea(
